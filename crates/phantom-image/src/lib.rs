...
//! - metadata storage;
//! - PNG, GIF and JPEG dimension probing;
//! - decoded RGBA8 validation;
//! - configurable decoded-memory limits;
//! - a narrow [`ImageDecoder`] contract;
//! - a bounded PNG/JPEG decoder backend using a mature codec boundary.
//!
...
/// Bounded PNG/JPEG raster decoder used by the first real image pipeline.
///
...
/// Probes intrinsic dimensions for PNG, GIF or JPEG without decoding pixels.
///
/// # Errors
///
